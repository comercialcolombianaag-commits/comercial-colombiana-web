...
import { ChevronDown, Car, Heart, Home, Building2, Briefcase, Target } from 'lucide-react';
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="hero-content">
          ...
          <div className="animate-fadeInUp hero-header">
            <h1 className="hero-title">¿Qué necesitas proteger hoy?</h1>
            <p className="hero-subtitle">Encuentra la protección perfecta para ti, tu familia o tu empresa. Más de 50 años cuidando lo que más valoras en Bogotá.</p>
          </div>
          ...
          <div className="services-grid">
            ...
            <a href="#auto" className="service-card" style={{ animationDelay: '0s' }}>
              ...
              <div className="card-cta">Ver opciones →</div>
            </a>
            ...
            <a href="#analisis" className="service-card hero-card" style={{ animationDelay: '0.1s' }}>
              ...
              <div className="card-cta hero-cta">Iniciar Análisis Gratuito →</div>
            </a>
