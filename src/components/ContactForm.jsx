...
const ContactForm = () => {
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Línea de atención personalizada',
      value: '(+57) 315 685-1089',
      link: 'tel:+573156851089',
      color: '#0066CC'
    },
    {
      icon: Mail,
      title: 'Correo electrónico',
      value: 'andres.arenas@comercialcolombiana.com',
      link: 'mailto:andres.arenas@comercialcolombiana.com',
      color: '#4A90E2'
    },
    {
      icon: MapPin,
      title: 'Dirección',
      value: 'Calle 57 #13-27 Piso 4 – Bogotá, Colombia',
      color: '#0066CC'
    },
    {
      icon: Clock,
      ...
      <div className="container">
        ...
        <div style={{
          ...
          <p style={{
            ...
            ¿Tienes dudas o necesitas tomar una buena decisión sobre tu seguro? Te ofrecemos acompañamiento humano, sin letra pequeña y con total claridad.
          </p>
        </div>
          ...
          <div style={{
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                <div>
                  ...
                  <input
                    ...
                    onBlur={(e) => !errors.firstName && (e.target.style.borderColor = '#E5E7EB')}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onFocus={(e) => e.target.style.borderColor = '#0066CC'}
                    onBlur={(e) => !errors.lastName && (e.target.style.borderColor = '#E5E7EB')}
                  />
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                <select
                  ...
                  onFocus={(e) => e.target.style.borderColor = '#0066CC'}
                  onBlur={(e) => !errors.type && (e.target.style.borderColor = '#E5E7EB')}
                >
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows="4"
                  placeholder="Cuéntanos más de lo que estás buscando"
                  style={{
                    width: '100%',
                    padding: '0.875rem',
                    border: errors.message ? '2px solid #EF4444' : '2px solid #E5E7EB',
                    borderRadius: '0.75rem',
                    fontSize: '1rem',
                    transition: 'border-color 0.3s ease',
                    outline: 'none',
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <label style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: '0.875rem', color: '#6B7280', lineHeight: '1.5' }}>
                    He leído y acepto los <a href="/terminos-y-condiciones" style={{ color: '#0066CC', textDecoration: 'underline' }}>Términos y Condiciones</a> y la <a href="/politica-tratamiento-de-datos" style={{ color: '#0066CC', textDecoration: 'underline' }}>Política de Tratamiento de Datos</a>.
                  </span>
                </label>
              ...
              <button
                ...
                style={{
                  width: '100%',
                  padding: '1.125rem',
                  background: isSubmitting ? '#9CA3AF' : 'linear-gradient(135deg, #0066CC 0%, #003B71 100%)',
                  color: 'white',
                  border: 'none',
                  borderRadius: '0.75rem',
                  fontSize: '1.125rem',
            ...
            <div style={{
              ...
              <p style={{ fontSize: '0.875rem', color: '#6B7280', marginBottom: '1rem' }}>
                ...
                href="https://outlook.office.com/bookwithme/user/80e5ce5edeaa452fa7dc47702b37d375@comercialcolombiana.com?anonymous&ismsaljsauthenabled"
                target="_blank"
